      ...
      <div class="col-md-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">{{$lesson->exists ? 'ویرایش درس ' . $lesson->title : 'ایجاد واژهٔ جدید'}}
            </h3>
            <hr>
            @if (count($errors) > 0)
              <div class="row">
            ...
            {!! Form::model($lesson, [
              ...
              <fieldset class="form-group">
                ...
                {!! Form::select('prerequisite_lesson', $lessons, $lesson->prerequisite_lesson, [ 'class' => 'selectpicker form-control', 'data-live-search' => 'true', 'multiple' => 'true', 'data-max-options' => '1']) !!}
              </fieldset>

              <fieldset class="form-group hidden">
                <label for="exampleTextarea">دوره پیش نیاز</label>
                {!! Form::text('course', $course->id,  [ 'class' => 'selectpicker form-control', 'data-live-search' => 'true', 'multiple' => 'true', 'data-max-options' => '1']) !!}
              </fieldset>
              ...
              <fieldset class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    <label for="exampleTextarea">ویدئوی درس</label>
