            ...
            <div class="box box-info">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <a href="{{route('admin.courses.createLesson', $course->id)}}" class="btn btn-success pull-left">افزودن درس به این دوره</a>
                </div>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                    ...
                    <tbody>
                      @foreach ($lessons as $lesson)
                        <tr>
                          ...
                          <td>{{$lesson->prerequisite_lesson}}</td>
                          <td>
                            <span>{{$lesson->questions->count()}} سوال</span>
                            </ul>
                          </td>
                          <td align="center">
                            <a href="{{route('admin.courses.editLesson', [$lesson->id, $course->id])}}" class="label label-info"><em class="fa fa-pencil"></em></a>
